...
static __inline bool adb_is_separator(char c) {
    return c == '\\' || c == '/';
}
...
static __inline bool adb_thread_create(adb_thread_func_t func, void* arg,
...
static __inline__ void adb_thread_exit() {
    _endthreadex(0);
}
